...
namespace service
{
    ...
    public class ProductDL
    {
        ...
        {
            foreach(Product p1 in ProductDL.purchasedproduct)
            {
                if (p1.Productname==name && p1.Productcategory==category && p1.Productcompany==company && p1.Productprice==price)
                {
                    purchasedproduct.Remove(p1);
