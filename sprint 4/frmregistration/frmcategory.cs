...
namespace frmregistration
{
    public partial class frmcategory : Form
    {
        ...
        public static string namemakeup;
        public static string pricemake;

        private static frmcategory login_frm;

        public static string Namemakeup { get => namemakeup; set => namemakeup = value; }
        public static string Pricemake { get => pricemake; set => pricemake = value; }
        ...
        private void cmdregister_Click(object sender, EventArgs e)
        {
            ...
            if (txtpassword.Text == txtconfirmpassword.Text)
            {
                ...
                Namemakeup = txtusername.Text;
                Pricemake = textBox2.Text;
            }
            else
            {
