...
namespace service
{
    ...
    public interface IService1
    {
        ...
        [OperationContract]
        void Addmakeupartist(string name, string password, string phone, string address,string category,string price);
        [OperationContract]
        List<Bill> Addbill(string card, string code, string mail);
        [OperationContract]
        ...
        [OperationContract]
        List<Customer> addrequestedcustomer(string n);
        [OperationContract]
        void mahi(Customer p);
        [OperationContract]
        string commission(string price);
        [OperationContract]
        List<MakeupArtist> commisionadmin(string name, string price);
